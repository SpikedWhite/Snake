...
public class SnakeWorld  extends World
{
    ...
    /**
     * act handles the actions that must be taken everytime the program is ran
    ...
    /**
     * set DX changes the stored x coordinate for a given Dot object
    ...
    /**
     * set DX changes the stored y coordinate for a given Dot object
     * @param d is the dot number
    ...
    public void addFood()
    {
        if(getObjects(Food.class).size() < 2)
    ...
    /**
     * addDot will add a new Dot object at the end of our snake
     * @pararm There are no parameters
     * @return Nothing is returned
     */
    public void addDot()
    {
